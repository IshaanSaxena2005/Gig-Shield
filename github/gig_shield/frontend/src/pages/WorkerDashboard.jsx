...
const WorkerDashboard = () => {
  // FIX: ALL hooks must be at the top — never after a conditional return
  ...
  const workerData = {
    ...
    platform: dashboardData?.user?.occupation || 'Delivery Platform',
    location: dashboardData?.user?.location || 'Location',
